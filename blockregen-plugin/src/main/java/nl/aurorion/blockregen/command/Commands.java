...
public class Commands implements CommandExecutor {
    ...
    private void sendHelp(CommandSender sender, String label) {
        sender.sendMessage(Strings.color(HELP
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "region": {
                ...
                switch (args[1].toLowerCase()) {
                    ...
                    case "world": {
                        ...
                        player.sendMessage(Strings.color(Message.REGION_FROM_WORLD.get(player)
                    ...
                    case "priority": {
                        ...
                        player.sendMessage(Strings.color(Message.REGION_PRIORITY_CHANGED.get(player)
                                .replace("%region%", args[2])
                    ...
                    case "set": {
                        ...
                        player.sendMessage(Strings.color(Message.SET_REGION.get(player)
                                .replace("%region%", args[2])));
                        return false;
                    }
                    case "delete": {
                    ...
                    case "all": {
                        ...
                        player.sendMessage(Strings.color(String.format(Message.SET_ALL.get(player), region.switchAll() ? "&aall" : "&cnot all")));
                        return false;
                    }
                    case "add": {
                        if (args.length > 4) {
            ...
            case "stats": {
                ...
                if (processes.isEmpty()) {
                    ...
                    sender.sendMessage(Strings.color(stats.toString()));
                    break;
                }
            ...
            case "discord":
                ...
                sender.sendMessage(Strings.color(
            ...
            case "events":
                ...
                if (args.length < 3) {
                    ...
                    if (plugin.getEventManager().getLoadedEvents().isEmpty()) {
                        sender.sendMessage(Strings.color("&8&m     &r &3BlockRegen Events &8&m     "
                    ...
                    sender.sendMessage(Strings.color(list.toString()));
                } else {
    ...
    private void giveTools(@NotNull Player player) {
        ...
        meta.setDisplayName(Strings.color("&3BlockRegen preset tool"));
        meta.setLore(Lists.newArrayList(Strings.color(
        ...
        meta.setDisplayName(Strings.color("&3BlockRegen selection tool"));
        meta.setLore(Lists.newArrayList(Strings.color("&fLeft click &7to select first position.",
    ...
    private void listRegions(CommandSender sender) {
        ...
        sender.sendMessage(Strings.color(message.toString()));
    }
