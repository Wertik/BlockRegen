...
**Why are classes in the "modern" module and package "...current" named "latest"?** \
Because the full classnames are used for JSON deserialization.
Existing `Data.json` files wouldn't load properly.
